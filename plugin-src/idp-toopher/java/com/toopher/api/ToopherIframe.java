...
public final class ToopherIframe {
    ...
    public String loginUri(String userName, String resetEmail, String requestToken) {
        return authUri(userName, resetEmail, "Log In", true, false, requestToken, "None", DEFAULT_TTL);
    }
     ...
     */
    public Map<String, String> validate(Map<String, String[]> params, String requestToken, long ttl) throws SignatureValidationError {
